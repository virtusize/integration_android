 ...
 */
enum class VirtusizeRegion(
    val value: String,
) {
    COM("com") {
        override fun defaultLanguage(): VirtusizeLanguage = VirtusizeLanguage.EN
    },
    JP("jp") {
        override fun defaultLanguage(): VirtusizeLanguage = VirtusizeLanguage.JP
    },
    KR("kr") {
        override fun defaultLanguage(): VirtusizeLanguage = VirtusizeLanguage.KR
    }, ;
