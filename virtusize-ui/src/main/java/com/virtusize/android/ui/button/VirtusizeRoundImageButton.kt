...
open class VirtusizeRoundImageButton
    @JvmOverloads
    constructor(
        context: Context,
        ...
        init {
            ...
            val buttonStyle =
                attrsArray.getInt(
                    R.styleable.VirtusizeRoundImageButton_roundImageButtonStyle,
                    VirtusizeRoundImageButtonStyle.DEFAULT.ordinal,
                )
            roundImageButtonStyle = VirtusizeRoundImageButtonStyle.values().firstOrNull {
                it.ordinal == buttonStyle
            } ?: VirtusizeRoundImageButtonStyle.DEFAULT

            val buttonSize =
                attrsArray.getInt(
                    R.styleable.VirtusizeRoundImageButton_roundImageButtonSize,
                    VirtusizeButtonSize.STANDARD.ordinal,
                )
