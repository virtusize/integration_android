    ...
    constructor(
        ...
        override fun initialSetup(
            ...
            val viewModelFactory =
                object : ViewModelProvider.Factory {
                    override fun <T : ViewModel> create(modelClass: Class<T>): T =
                        VirtusizeInPageStandardViewModel(
                            VirtusizeRepository(
                                context,
            ...
            (context as? LifecycleOwner)?.apply {
                viewModel
                    ?.productNetworkImageLiveData
                    ?.observe(this, { productImageViewBitMapPair ->
                ...
                viewModel
                    ?.productPlaceholderImageLiveData
                    ?.observe(this, { productImageViewDataPair ->
                        productImageViewDataPair.first.setProductPlaceHolderImage(
                            productImageViewDataPair.second.productType,
                            productImageViewDataPair.second.storeProductMeta
                                ?.additionalInfo
                                ?.style,
                        )
                    })
