...
class VirtusizeInPageMini
    ...
    constructor(
        ...
        override fun showInPageError(externalProductId: String?) {
            ...
            binding.inpageMiniText.setTextColor(ContextCompat.getColor(context, com.virtusize.android.ui.R.color.vs_gray_700))
        ...
        override fun setStyle() {
            if (virtusizeBackgroundColor != 0) {
                ...
                setButtonRightArrowColor(ContextCompat.getColor(context, com.virtusize.android.ui.R.color.vs_teal))
            }
        }
