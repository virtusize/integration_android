...
class I18nLocalizationJsonParserTest {
    ...
    fun parseI18N_englishLocalization_shouldReturnExpectedObject() {
        val actualI18nLocalization = I18nLocalizationJsonParser(context, I18nLocalizationJsonParser.TrimType.CLEAN).parse(readFileFromAssets("/i18n_en.json"))
    ...
    fun parseI18N_emptyJsonData_shouldReturnExpectedObject() {
        val actualI18nLocalization = I18nLocalizationJsonParser(context, I18nLocalizationJsonParser.TrimType.CLEAN).parse(TestFixtures.EMPTY_JSON_DATA)
    ...
    fun parseI18NJP_japaneseLocalization_shouldReturnExpectedObject() {
        ...
        val actualI18nLocalization = I18nLocalizationJsonParser(localizedContext, I18nLocalizationJsonParser.TrimType.CLEAN).parse(readFileFromAssets("/i18n_jp.json"))
    ...
    fun parseI18NKO_koreanLocalization_shouldReturnExpectedObject() {
        ...
        val localizedContext = context.createConfigurationContext(conf)
        val actualI18nLocalization = I18nLocalizationJsonParser(localizedContext, I18nLocalizationJsonParser.TrimType.CLEAN).parse(readFileFromAssets("/i18n_ko.json"))
